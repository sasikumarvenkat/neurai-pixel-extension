...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_PATH_CONTENT_TRACKING_ENABLED = 'piwik/tracking/content_tracking_enabled';
    ...
    /**
     * Check if Piwik content tracking is enabled
     *
     * @param null|string|bool|int|Store $store
     * @return bool
     */
    public function isContentTrackingEnabled($store = null)
    {
        return $this->scopeConfig->isSetFlag(
                self::XML_PATH_CONTENT_TRACKING_ENABLED,
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
                $store
            ) && $this->isTrackingEnabled($store);
    }
